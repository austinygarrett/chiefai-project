    ...
    async def login_user(
        ...
        return dict(
            ...
            content={
                ...
                "data": jsonable_encoder(UserOutData.model_validate(searched_user)),
                "token": created_token.access_token,
            },
        )
    ...
    async def register_user(
        ...
        if duplicate_user:
            return dict(
                status_code=HTTP_400_BAD_REQUEST,
                content={
                    "message": constant.FAIL_VALIDATION_USER_DUPLICATED,
                },
            )
        created_user = await users_repo.register_user(user_in=user_in)
        ...
        return {
            ...
            "content": {
                ...
                "data": jsonable_encoder(UserOutData.model_validate(created_user)),
                "token": created_token.access_token,
            }
        }
